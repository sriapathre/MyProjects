...
namespace LogMyTime
{
    public class ImageButton : Button
    {
        ...
        public ImageButton()
        {
            this.SetCurrentValue(ImageButton.ImageLocationProperty, LogMyTime.ImageLocation.Left);
        }
